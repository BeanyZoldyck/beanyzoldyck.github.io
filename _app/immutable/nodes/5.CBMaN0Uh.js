import{a as I,f as A}from"../chunks/XXBoFCUk.js";import{q as B,s,F as x,z as M,y as r,Q as l,B as h,C as d,g as m,A as G,G as T}from"../chunks/C4Dvzcg6.js";import{p as P}from"../chunks/C6lHQQpI.js";import{d as R,a as D,s as u}from"../chunks/CiMOW27P.js";import{e as H,i as W}from"../chunks/CsGCm_XY.js";import{s as N}from"../chunks/CPlneDfx.js";import{r as q}from"../chunks/mtVfim1D.js";const O=`I finally got around to making a personal dev site. I'm no (good) frontend dev, so it may be a little underwhelming, but it's mine. 
\\n
...
`,E=`I just visited San Francisco for the first time this last weekend. \\n
...
`,Q=`I was passively scrolling X in the hopes of magically growing my tech account when I came across (this post). In the post the idea of stack overflow for agents is facetiously proposed, given as a "unicorn idea".\\n
...
`,V=`I have a nonserious addiction. I attend a lot of hackathons.\\n
\\n
...
`;var X=A('<p class="text-white"> </p>'),U=A('<section class="py-20"><h1 class="mb-8 text-4xl font-bold text-purple-300"> </h1> <div class="space-y-6"><div class="inline-flex"><p class="border-l-2 pl-1 text-xs text-mauve-500"></p> <p class="tooltip ml-1 pl-3 text-xs text-mauve-500"><button class="cursor-pointer"> </button></p></div> <div class="border-l-2 border-purple-800 pl-6"><p class="text-lg text-purple-600"> </p></div> <!></div> <div class="mt-15 border-l-2 border-purple-900 pl-6"><a class="text-lg text-purple-800">← back</a></div></section>');function Y(p,e){B(e,!0);let t=G("");switch(e.article.link){case"site":s(t,O,!0);break;case"SF":s(t,E,!0);break;case"KBT":s(t,Q,!0);break;case"bearhacks":s(t,V,!0);break;default:s(t,"");break}function g(n){let o=new Date(n-18e6).toISOString().replaceAll("-","/").replaceAll("Z","").split("T");return o[1]=o[1].split(".")[0],o.join(" @ ")}function w(n){alert("In your time: "+new Date(n).toLocaleString())}var a=U(),i=h(a),S=l(i,!0),f=r(i,2),y=h(f),v=r(h(y),2),k=h(v),F=l(k);d(v),d(y);var b=r(y,2),_=h(b),j=l(_,!0);d(b);var L=r(b,2);H(L,17,()=>m(t).split("\\n"),W,(n,c)=>{var o=X(),K=l(o,!0);x(()=>u(K,m(c))),I(n,o)}),d(f);var z=r(f,2),C=l(z);d(a),x((n,c)=>{u(S,e.article.title),u(F,`edited ${n??""}`),u(j,e.article.header),N(C,"href",c)},[()=>g(e.article.edited),()=>q("/blog")]),D("click",k,()=>{w(e.article.edited)}),I(p,a),M()}R(["click"]);function oe(p,e){B(e,!0);let t=T(()=>P.params.article||"");const g=[{link:"site",title:"personal site",header:"took me long enough",edited:1772718227084},{link:"bearhacks",title:"chuka - caffeine = fraud?",header:"hype moments and aura was not enough to bring back a win",edited:1784272609e3},{link:"SF",title:"fist time in SF",header:"got citymogged so hard I wrote this on the flight back",edited:1780889081910},{link:"KBT",title:"knowledge based tooling",header:"we DONE with RAG",edited:1785214125799}];function w(a){for(const i of g)if(i.link==a)return i;return{link:"none",title:"Article not found!",header:"just go back to blogs using the button below",created:0,edited:Date.now()}}{let a=T(()=>w(m(t)));Y(p,{get article(){return m(a)}})}M()}export{oe as component};
