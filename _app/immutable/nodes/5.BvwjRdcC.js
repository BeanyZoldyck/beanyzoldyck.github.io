import{a as w,f as _,c as X}from"../chunks/XXBoFCUk.js";import{q as C,s as c,F as A,z as L,y as u,Q as l,B as m,C as g,x as j,g as e,P as U,G as B,A as Y}from"../chunks/C4Dvzcg6.js";import{p as Z}from"../chunks/CexWzut7.js";import{d as J,a as $,s as f}from"../chunks/CiMOW27P.js";import{i as ee}from"../chunks/DwloG4jm.js";import{e as te,i as ae}from"../chunks/CsGCm_XY.js";import{s as y}from"../chunks/CPlneDfx.js";import{r as ne,a as oe}from"../chunks/VkCwbT7W.js";const ie=`I finally got around to making a personal dev site. I'm no (good) frontend dev, so it may be a little underwhelming, but it's mine. 
\\n
...
`;var he=_('<a target="_blank"><img/></a> <br/>',1),de=_('<p class="text-white"> </p>'),ce=_('<section class="py-20"><h1 class="mb-8 text-4xl font-bold text-purple-300"> </h1> <div class="space-y-6"><div class="inline-flex"><p class="border-l-2 pl-1 text-xs text-mauve-500"></p> <p class="tooltip ml-1 pl-3 text-xs text-mauve-500"><button class="cursor-pointer"> </button></p></div> <div class="border-l-2 border-purple-800 pl-6"><p class="text-lg text-purple-600"> </p></div> <!></div> <div class="mt-15 border-l-2 border-purple-900 pl-6"><a class="text-lg text-purple-800">← back</a></div></section>');function ue(b,t){C(t,!0);let a=Y("");switch(t.article.link){case"site":c(a,ie,!0);break;case"SF":c(a,se,!0);break;case"KBT":c(a,re,!0);break;case"bearhacks":c(a,le,!0);break;default:c(a,"");break}function v(i){let s=new Date(i-18e6).toISOString().replaceAll("-","/").replaceAll("Z","").split("T");return s[1]=s[1].split(".")[0],s.join(" @ ")}function k(i){alert("In your time: "+new Date(i).toLocaleString())}var o=ce(),h=m(o),P=l(h,!0),I=u(h,2),x=m(I),M=u(m(x),2),S=m(M),z=l(S);g(M),g(x);var T=u(x,2),G=m(T),K=l(G,!0);g(T);var D=u(T,2);te(D,17,()=>e(a).split("\\n"),ae,(i,n)=>{var s=X(),H=j(s);{var N=r=>{var d=he(),p=j(d),F=l(p);U(2),A((E,Q,V)=>{y(p,"href",E),y(F,"src",Q),y(F,"alt",V)},[()=>e(n).split(";")[3],()=>oe(`/pics/${e(n).split(";")[1]}`),()=>e(n).split(";")[2]]),w(r,d)},O=B(()=>e(n).startsWith("\\img",1)),q=r=>{var d=de(),p=l(d,!0);A(()=>f(p,e(n))),w(r,d)};ee(H,r=>{e(O)?r(N):r(q,-1)})}w(i,s)}),g(I);var R=u(I,2),W=l(R);g(o),A((i,n)=>{f(P,t.article.title),f(z,`edited ${i??""}`),f(K,t.article.header),y(W,"href",n)},[()=>v(t.article.edited),()=>ne("/blog")]),$("click",S,()=>{k(t.article.edited)}),w(b,o),L()}J(["click"]);function ke(b,t){C(t,!0);let a=B(()=>Z.params.article||"");const v=[{link:"site",title:"personal site",header:"took me long enough",edited:1772718227084},{link:"bearhacks",title:"chuka - caffeine = fraud?",header:"hype moments and aura was not enough to bring back a win",edited:1784272609e3},{link:"SF",title:"fist time in SF",header:"got citymogged so hard I wrote this on the flight back",edited:1780889081910},{link:"KBT",title:"knowledge based tooling",header:"we DONE with RAG",edited:1789417145010}];function k(o){for(const h of v)if(h.link==o)return h;return{link:"none",title:"Article not found!",header:"just go back to blogs using the button below",created:0,edited:Date.now()}}{let o=B(()=>k(e(a)));ue(b,{get article(){return e(o)}})}L()}export{ke as component};
